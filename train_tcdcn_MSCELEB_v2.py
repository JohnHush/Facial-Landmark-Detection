...
saved_model_dir = '/home/jh/working_data/resnet18_face_lilei/tf_model'
...
if __name__ == "__main__":
    ...
    train_op = tf.train.AdamOptimizer( learning_rate = \
            0.0001 ).minimize( loss_landmark , var_list = trainable_list )
    ...
    for i in range( 10000 ):
        ...
        _ , loss , summary = sess.run(\
                ...
                label_placeholder : train_landmarks }
                )
        ...
        if i% 10 == 0:
            ...
            loss, summary = sess.run( \
                    ...
                    label_placeholder : test_landmarks }
                    )
